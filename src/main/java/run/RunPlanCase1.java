...
public class RunPlanCase1 {
    ...
    private static final String pathToConfig = "./scenario/open-vulkaneifel-scenario/vulkaneifel-plan-case-1.config.xml";
    ...
    public static void main(String[] args) {
        ...
        for(int size = 20; size < 160; size += 10){
            ...
            multiModeDrtConfig.getModalElements().forEach(drtConfigGroup -> {
                ...
                drtConfigGroup.setVehiclesFile(vehicleDirectory + finalSize + "-1_seater-drt-vehicles.xml");
            });
